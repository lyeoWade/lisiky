...
<title>性感模特 - 第七图官网（www.images007.com）</title>
...
<div class="main">
  ...
  <div class="main-content">
    <div class="currentpath">当前位置:<a href="http://www.images007.com/">第七图</a> » 性感模特</div>
    <div class="postlist moteer">
      <ul id="pins">
        <?php 
        $id=$_GET['id'];
        ...
        //echo $page;
        $count=mysql_query("select count(*) from modler "); //获得记录总数
        ...
        $result=mysql_query("select * from modler order by createTime desc limit $startCount,$perNumber"); //根据前面的计算出开始的记录和记录数
        
        while ($row=mysql_fetch_array($result)) {
        ?>
        <li>
          <a href="search.html?name=<?php echo $row['name'];?>" target="_blank"><img width="236" height="354" class="lazy" alt="啊实打实的" src="<?php echo substr($row['coverpic'],3)?>"  data-original="" style="display: inline;" data-bd-imgshare-binded="1"></a>
          <div class="floatlayer">
            <h2><a href="search.html?tag=<?php echo $row['name'];?>" target="_blank"><?php echo $row['name'];?></a></h2>
