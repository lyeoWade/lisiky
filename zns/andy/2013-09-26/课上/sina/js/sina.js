...
function cnxh()
{
	...
	for(var i=0; i<iBtn.length; i++)
	{
		...
		iBtn[i].onmouseover=function()
		{
			...
			iCon[this.index].className='comList';
		}
	}
}
...
function gameX()
{
	var oGameX=document.getElementById('gameX');
	var aSpan=oGameX.children[1].getElementsByTagName('a');
	var oCon=oGameX.children[1].getElementsByTagName('div');
